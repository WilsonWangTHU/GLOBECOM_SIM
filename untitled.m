...
arrivalRate = [0.4, 0.4,0.4, 0.4];
leaveRate = [0.1, 0.1, 0.1,0.1];

sunlightCoeff = [0.125 * iArrival, 0.125/2 * iArrival];

filename = [num2str(iArrival) 'fig4lightRateResult.alpha'];
...
save('fig10.mat','proposedReward', 'proposedEnergyHarvest',...
