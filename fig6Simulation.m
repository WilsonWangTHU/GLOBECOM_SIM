...
arrivalRate = 0.3;
leaveRate = [0.01 * iArrival];


filename = [num2str(iArrival) 'fig1arrivalRateResult.alpha'];
...
leaveRate = [0.01 * [1:16]];
save('fig6.mat','proposedReward', 'proposedEnergyHarvest',...
...
g = 160/255;
b = 37/255;
plot(leaveRate, proposedEnergyHarvest ./ nRunning, 's-','LineWidth',WIDTH,'Color',[r g b],'MarkerSize',7);
box on;
hold on;
grid on;
...
g = 23/255;
b = 71/255;
plot(leaveRate, energyEnergyHarvest ./ nRunning, 's-','LineWidth',WIDTH,'Color',[r g b],'MarkerSize',7);

r = 23/255;
g = 53/255;
b = 201/255;
plot(leaveRate, randomEnergyHarvest ./ nRunning, 's-','LineWidth',WIDTH,'Color',[r g b],'MarkerSize',7);


r = 237/255;
g = 125/255;
b = 49/255;
plot(leaveRate, myopicEnergyHarvest ./ nRunning, 's-','LineWidth',WIDTH,'Color',[r g b],'MarkerSize',7);


r = 20/255;
g = 125/255;
b = 237/255;
plot(leaveRate, CSMAenergyHarvested ./ nRunning, 's-','LineWidth',WIDTH,'Color',[r g b],'MarkerSize',7);
